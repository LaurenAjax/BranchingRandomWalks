...
class Node:
    ...
    def plot_trace_path_helper(self, arr, plot):
        ...
        # For each child of this Node:
            child.plot_trace_path_helper(self.pos, plot)
        ...
        # If this Node has no children:
            plot.plot([self.pos[0]], [self.pos[1]], 'o', color=(1, 0, 0, .1))
            # Plot the position of this Node as a dot.
    
    def plot_trace_path(self, plot):
        """Plot the path of this Node."""
        for child in self.child:
...
living = []
next = []
root = Node([0, 0], living, None, math.radians(30))
...
ax2.plot(range(generations), clusters, color = (0, 1, 1, 1))
